...
class QuizCheckScreen extends StatefulWidget {
  final List<Quiz> quizs;
  final Map<int, dynamic> userAnswers;

  const QuizCheckScreen({super.key, required this.quizs, required this.userAnswers});

  @override
  State<StatefulWidget> createState() => _QuizCheckScreenState();
}

class _QuizCheckScreenState extends State<QuizCheckScreen> {
  int currentIndex = 0;
