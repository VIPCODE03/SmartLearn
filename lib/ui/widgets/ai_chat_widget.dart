...
class _WdgChatState extends State<WdgChat> {
  ...
  ///---  Xây dựng giao diện cho mỗi item tin nhắn  -------------
          ...
          children: <Widget>[
            ...
            PerformerProvider(
                ...
                child: ConductorBuilder<GeminiConductor>(builder: (context, performer) {
                  ...
                  if(currentState.state == GemState.done && _newMess) {
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      if (mounted && _newMess) {
                        _newMess = false;
                  ...
                  if(currentState.state == GemState.progress) {
                    WidgetsBinding.instance.addPostFrameCallback((_) {
                      if (mounted) {
                        _addContentEnting();
                      }
                  ...
                  return BounceButton(
                      onTap: currentState.state == GemState.progress || !_hasText
                          ? () {}
                          : () {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            color: currentState.state == GemState.progress || !_hasText
                                ? Colors.grey
