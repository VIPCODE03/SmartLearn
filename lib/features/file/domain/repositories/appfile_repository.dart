...
abstract class REPAppFile {
  Future<Either<Failure, ENTAppFile>> createFile(ENTAppFile file, {required FileExtenalValue foreign});
  ...
  Future<Either<Failure, List<ENTAppFile>>> getFiles(String pathId, {required FileExtenalValue foreign});
  Future<Either<Failure, ENTAppFile?>> getFile(String id);

  Future<Either<Failure, ENTAppFile?>> getFileByPathName(String pathId, String name, {required FileExtenalValue foreign});
}