...
/// A utility class holding constants for screen configuration and communication.
///
/// This class prevents the use of "magic strings" and provides a single
/// source of truth for all screen-related constants.
abstract class FlashCardSetNativeConfig {
  ...
  static const String channelName = 'com.zent.smartlearn.smart_learn/screen';

  /// The name of the screen provider on iOS.
  static const String iOSWidgetName = 'FlashcardWidgetProvider';

  /// The name of the screen provider on Android.
  static const String androidWidgetName = 'FlashcardWidgetProvider';

  // --- Method Invocation ---
  /// The name of the method to invoke on the native side to update screen data.
  static const String updateMethodName = 'update';

  /// The name of the method to invoke on the native side to remove screen data.
