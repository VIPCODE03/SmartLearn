...
class AITextQuestionScreen extends StatefulWidget {
  const AITextQuestionScreen({super.key});

  @override
  State<AITextQuestionScreen> createState() => _AITextQuestionScreenState();
}

class _AITextQuestionScreenState extends State<AITextQuestionScreen> {
