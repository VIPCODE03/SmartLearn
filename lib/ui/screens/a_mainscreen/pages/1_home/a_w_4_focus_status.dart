...
//         child: PerformerBuilder<FocusPerformer>(
//             builder: (context, performer) {
//               final state = performer.current;
//               final bool isFocusing = state is FocusingState;
//
//               return Column(
...
//                         onChanged: (changed) {
//                           isFocusing
//                               ? performer.add(StopFocus())
//                               : performer.add(StartFocus());
//                         },
//                         activeColor: color,
//                       )
//                     ],
...
//                           Text(TimeFormatterUtil.fomathhmm(state.weeklyFocus.total)),
//                         ],
//                       ),
//
...
//
//                       Expanded(
//                           child: _WeeklyLearningChart(hoursPerDay: state.weeklyFocus.hourList)
//                       )
//                     ],
//                   ),
//                 ],
